...
class AmiTestServer extends EventEmitter{
     ...
     */
    _getClientsCount(){
        return Object.keys(this._authClients).length + Object.keys(this._unAuthClients).length;
    }
    ...
    static objectValues(clients){
        return Object.keys(clients).reduce((clients, key) => {
            clients.push(clients[key]);
            return clients;
        }, []);
    }
